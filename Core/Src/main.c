...
int main(void)
{
  ...
  /* 测试2: 画矩形边框 */
  ILI9341_DrawRect(10, 10, 220, 300, COLOR_WHITE);

  /* 测试3: 画线 */
  ILI9341_DrawLine(10, 10, 229, 309, COLOR_YELLOW);
  ILI9341_DrawLine(229, 10, 10, 309, COLOR_CYAN);

  /* 测试4: 画圆 */
  ILI9341_DrawCircle(120, 160, 60, COLOR_MAGENTA);
